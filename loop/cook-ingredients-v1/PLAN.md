# Hearth cooking ingredients — plan v1

Status: proposed; initial human plan approval pending. No product development started.
...
|---|---|---|
| R1 / A1 | Focused cards use the panel and 22-point ingredient rows; normal-scale heading 18 points; spacing as specified above. | Actual Flutter captures, widget geometry/type assertions, Astra visual review. |
...
Exact: content/matching/scaling semantics, panel heading, base type sizes, public component default behavior, data boundaries.
Bounded: spacing may vary by at most 4 logical pixels after Astra visual review; reading width at most 560; row font never below 22 before accessibility scaling; no text-scale cap.
